...
import { BeamService, BlockService, LumNetworkService, TransactionService, ValidatorDelegationService, ValidatorService, ProposalsVotesService, ProposalsDepositsService } from '@app/services';
