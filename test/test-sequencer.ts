...
// This CustomSequencer aims to give a particular order for the e2e tests for the chain-bridge
// In order of execution we justify the following steps as it follows our current business flow
// 1) Check health of server
// 2) Seed blocks and run e2e tests
// 3) Seed validators and run e2e tests
// 4) Seed transactions and run e2e tests
// 5) Seed beams and run e2e tests
// 6) Run e2e tests on accounts
// 7) Run e2e tests on core
// 8) Run e2e tests on governance
// 9) Run e2e tests on stats
// 10) Run e2e tests on dfract
